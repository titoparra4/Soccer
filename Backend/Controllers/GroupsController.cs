...
namespace Backend.Controllers
{
    ...
    public class GroupsController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "GroupId,Name,Logo,OwnerId")] Group group)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "GroupId,Name,Logo,OwnerId")] Group group)
        {
            if (ModelState.IsValid)
            {
